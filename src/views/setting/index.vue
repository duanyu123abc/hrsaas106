...
<script>
import { getRoleList, getCompanyInfo, deleteRole, getRoleDetail, updataRole, addRole, assignPerm } from '@/api/setting'
...
export default {
  ...
  methods: {
    ...
    async assignPerm(id) {
      ...
      this.roleId = id
      // 获取这个id所拥有的权限点
      const { permIds } = await getRoleDetail(id) // permIdshi当前觉得所拥有的权限点数据
